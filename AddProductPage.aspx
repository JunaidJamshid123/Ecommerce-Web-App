<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddProductPage.aspx.cs" Inherits="ShopVista__Ecommerce_Web_App_.AddProductPage" %>
    ...
    <form id="form1" runat="server">
        ...
        <div id="content">
            ...
            <div id="addProductForm">
                <h3>Add Product</h3>
                <form>
                   <asp:Label runat="server" AssociatedControlID="productName">Enter Product Name:</asp:Label>
<asp:TextBox runat="server" ID="productName" CssClass="form-control" Required="true"></asp:TextBox>

<asp:Label runat="server" AssociatedControlID="productPrice">Enter Product Price:</asp:Label>
<asp:TextBox runat="server" ID="productPrice" CssClass="form-control" Required="true"></asp:TextBox>
...
<asp:Label runat="server" AssociatedControlID="image">Image:</asp:Label>
